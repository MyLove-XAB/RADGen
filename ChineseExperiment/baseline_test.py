...
doc = []
val_news = pd.read_csv('/share/home/xuaobo/ai_studio/tasks/data/ChineseData/test_select.csv')
...
def transSum(input_document, env, decoder_maxlen):
    ...
    :param input_document: a series of document sequence
...
base.to_csv('/share/home/xuaobo/ai_studio/tasks/res/Chinese/test_baseline1_ep{}.csv'.format(ep_num))
print("Save Results")